  ...
  <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="img/header-line.png" alt="Line" class="tm-header-line">&nbsp;Delete&nbsp;&nbsp;<img src="img/header-line.png" alt="Line" class="tm-header-line"></h2>
          ...
          <a href="#main" class="tm-more-button tm-more-button-welcome">Delete</a>      
        </div>
    ...
    <div class="tm-main-section light-gray-bg">
      <div class="container" id="main">
        <section class="tm-section row">
          <h2 class="col-lg-12 margin-bottom-30">Delete</h2>
          <form action="<?= $_SERVER['PHP_SELF']?>" method="post" class="tm-contact-form">
            <div class="col-lg-6 col-md-6">
              <div class="form-group">
                <input type="text" id="contact_name" name="id" class="form-control" placeholder="id" />
              </div>
              <div class="form-group">
                <input class="tm-more-button" type="submit" onclick="envoyer()" value="Delete" name="submit" style="border: none; outline: none;">
              </div>
            </div>
